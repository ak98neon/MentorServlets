...
public final class Queries {
    ...
    public static final String INSERT_EMPLOYEE = "INSERT INTO " + Employee.TABLE_NAME + " (" + Employee.NAME_COLUMN
            ...
            + ", " + Employee.DEPARTMENT_ID
            + ") " + "VALUES (?, ?, ?, ?, ?, ?);";
    public static final String DELETE_EMPLOYEE = "DELETE FROM " + Employee.TABLE_NAME + " WHERE " + Employee.ID_COLUMN + " = ?;";
    public static final String SELECT_ALL_EMPLOYEE = "SELECT * FROM " + Employee.TABLE_NAME + ";";
    public static final String SELECT_ALL_EMPLOYEE_BY_DEPARTMENTS = "SELECT * FROM " + Employee.TABLE_NAME + " WHERE " + Employee.DEPARTMENT_ID + " = ?;";
